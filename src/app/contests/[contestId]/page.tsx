    ...
    <div className="max-w-4xl mx-auto min-h-screen min-w-max p-6 bg-gradient-to-r from-blue-500 via-indigo-600 to-blue-700 rounded-lg shadow-lg space-y-6 text-white">
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          <strong className="text-lg">Theme(Riddle):</strong>
          <span className="text-gray-200">{contestData.theme}</span>
        </div>
        <div className="flex justify-between items-center">
          <strong className="text-lg">Entry Cost:</strong>
          <span className="text-gray-200">${contestData.entryCost}</span>
        </div>
        <div className="flex justify-between items-center">
          <strong className="text-lg">Score to Win:</strong>
          <span className="text-gray-200">{contestData.scoreToWin}</span>
        </div>
        <div className="flex justify-between items-center">
          <strong className="text-lg">Contract Address:</strong>
          <span className="text-gray-200">{contestData.contractAddress}</span>
        </div>
      </div>
